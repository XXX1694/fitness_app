...
import 'package:tamos_family_club/features/payment/presentation/widgets/payment_subscription_block.dart';
...
class PaymentPage extends StatefulWidget {
  const PaymentPage({super.key, required this.name, required this.cost});
  final String name;
  final String cost;
                ...
                child: Column(
                  children: [
                    Expanded(
                      ...
                      child: Center(
                        child: Center(
                          child: PaymentSubscriptionBlock(
                            name: widget.name,
                            cost: widget.cost,
                          ),
                        ),
                      ),
                    ), // Show info about your selected subscrption
